	...
	class WPDesk_Helper_Plugin {
		...
		public function inactive_notice() { ?>
			...
			<div class="update-nag">
				<?php printf( __( 'The %s%s%s License Key has not been activated, so the plugin is inactive! %sClick here%s to activate the license key and the plugin.', 'flexible-checkout-fields-pro' ), '<strong>', $this->plugin_data['product_id'], '</strong>', '<a href="' . esc_url( admin_url( 'admin.php?page='.$this->ame_activation_tab_key ) ) . '">', '</a>' ); ?>
			</div>
			<?php
		}
