...
var Pagination = function (el, options) {
	...
	onPageRangeComboChange = function () {
		var psValue = Number(jQuery(this).val()),
	...
	getRenderedPageRange = function () {
		...
		jQuery.each(pageRange, function (i, p) {
	...
	getRenderedPageNumbers = function () {
		...
		result = '<li data-page="' + FIRST_PAGE_NUMBER + '"><a class="button"><span aria-hidden="true">' + firstPageLabel + '</span></a></li>' +
				 '<li data-page="' + PREVIOUS_PAGE_NUMBER + '"><a class="button"><span aria-hidden="true">' + previousPageLabel + '</span></a></li>';

		jQuery.each(pageNumbers, function (i, p) {
			result += '<li data-page="' + p + '" ' + (p === currentPage ? 'class="active"' : '') + '><a class="button">' + p + '</a></li>';
		});

		result += '<li data-page="' + NEXT_PAGE_NUMBER + '"><a class="button"><span aria-hidden="true">' + nextPageLabel + '</span></a></li>' +
				  '<li data-page="' + LAST_PAGE_NUMBER + '"><a class="button"><span aria-hidden="true">' + lastPageLabel + '</span></a></li>';
