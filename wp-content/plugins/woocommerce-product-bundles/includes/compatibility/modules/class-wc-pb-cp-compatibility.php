...
class WC_PB_CP_Compatibility {
	...
	public static function composite_show_product_bundle( $product, $component_id, $composite ) {
		...
		$base_price_incl_tax = wc_get_price_including_tax( $product, array( 'qty' => 1, 'price' => 1000 ) );
		$base_price_excl_tax = wc_get_price_excluding_tax( $product, array( 'qty' => 1, 'price' => 1000 ) );
