...
<div class="row cart-discount">
	<div class="col-md-6 col-lg-5 offset-md-6 offset-lg-7 bg-khaki">
		<?php if ( wc_coupons_enabled() ) { ?>
			<div class="coupon p1">
				...
				<input type="submit" class="button" name="apply_coupon" value="<?php esc_attr_e( 'Apply Discount', 'woocommerce' ); ?>" />
