...
<div class="woocommerce_account_subscriptions">
	...
	<?php else : ?>
		...
		<div class="notice woocommerce-error">
			<p class="no_subscriptions">
				You have no active memberships. <a href="/join" class="button ml1">Purchase a membership</a>
				<?php
			// translators: placeholders are opening and closing link tags to take to the shop page
			//printf( esc_html__( 'You have no active memberships. Find your first subscription in the %sstore%s.', 'woocommerce-subscriptions' ), '<a href="' . esc_url( apply_filters( 'woocommerce_subscriptions_message_store_url', get_permalink( wc_get_page_id( 'shop' ) ) ) ) . '">', '</a>' );
				?>
			</p>
		</div>
