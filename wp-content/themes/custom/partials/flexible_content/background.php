...
<section class="block flexible-content fc fc-background <?php echo $fc_background_classes; ?>">
	<?php if( $background_type === 'image' ): ?>
		<?php WS_Flexible_Content_Helper::fc_background_image( $background_image, $section_height_image, $background_image_masking ); ?>
		<?php if( $include_text ): ?>
			<div class="container-fc fc-background-text">
				<div class="row">
					<div class="col-sm-12">
						<?php WS_Flexible_Content_Helper::fc_background_text($heading, $text_alignment, $text_color, $subheading, $link_url, $link_text); ?>
					</div>
				</div>
			</div>
		<?php endif; ?>
	...
	<?php elseif( $background_type === 'multi-column'): ?>
		<div class="fc-background-multi-column-container <?php // echo 'vhmin' . $section_height_image; ?> <?php echo $multi_column_layout; ?> <?php echo $image_width; ?>">
			<div class="fc-background-multi-column-1 <?php // echo 'vhmin' . $section_height_image; ?> <?php if( $multi_column_layout === 'image-right' ): echo $background_color; ?> <?php endif; ?>">
			...
			<div class="fc-background-multi-column-2 <?php // echo 'vhmin' . $section_height_image; ?> <?php if( $multi_column_layout === 'image-left' ): echo $background_color; ?> <?php endif; ?>">
