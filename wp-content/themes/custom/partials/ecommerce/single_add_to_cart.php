    ...
    <div class="single-sidebar-middle">
      <div class="row">
        <div class="col-12 add-to-cart-price">
          ...
          You already have this class in your <a href="/cart">cart.</a>
          <?php else: ?>
            You already have <span class="bold"><?php echo $class_in_cart->get_name(); ?></span> in your <a href="/cart">cart.</a>
          <?php endif; ?>
        </div>
