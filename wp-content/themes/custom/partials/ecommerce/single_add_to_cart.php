                    ...
                    <div class="col-<?php if ( $is_classes ) : ?>12<?php else: ?>6<?php endif; ?> add-to-cart-price">
                        ...
                        <h5 class="price">
                           ...
                           <?php if ( $is_member_or_has_membership_in_cart && $current_price > 0 ) : ?>
                               ...
                               <?php if ( $membership_discount > 0 ) : ?><p class="non-members-price">(<?php echo wc_price( $current_price ); ?> For Non-members)</p><?php endif; ?>

                            <?php elseif ( $current_price > 0 ): ?>

                               <p class="non-members-price"><?php echo wc_price( $current_price ); ?> Per Person</p>
                              <?php if ( $membership_discount > 0 ) : ?><p class="non-members-price">(<?php echo wc_price( $current_price - $membership_discount ); ?> For Members!)</p><?php endif; ?>
