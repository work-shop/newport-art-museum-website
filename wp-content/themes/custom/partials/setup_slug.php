...
if( NAM_Helpers::is_tree(76) || is_tax( 'classes-categories' ) || is_post_type_archive( 'classes' ) ): $GLOBALS['tree_slug'] = 'education'; $GLOBALS['include_page_nav'] = true; endif;
if( NAM_Helpers::is_tree(74) || is_tax( 'events-categories' ) ||is_post_type_archive( 'events' ) ): $GLOBALS['tree_slug'] = 'events'; $GLOBALS['include_page_nav'] = true; endif;
...
if( NAM_Helpers::is_tree(7) || NAM_Helpers::is_tree(6) ): $GLOBALS['tree_slug'] = 'my_account'; 
